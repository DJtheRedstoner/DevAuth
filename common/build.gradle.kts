...
dependencies {
    ...
    implementation("com.mojang:authlib:1.5.21")                     // 1.18.2: 3.3.39  1.12.2: 1.5.25  1.8.9: 1.5.21
    implementation("org.apache.logging.log4j:log4j-core:2.17.0")    // 1.18.2: 2.17.0  1.12.2: 2.8.1   1.8.9: 2.0-beta9
    implementation("com.google.code.gson:gson:2.2.4")               // 1.18.2: 2.8.9   1.12.2: 2.8.0   1.8.9: 2.2.4
